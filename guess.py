...
tf.app.flags.DEFINE_string('class_type', 'age','Classification type')
tf.app.flags.DEFINE_string('target', '', 'CSV file containing the filename processed along with best guess and score')
...
FLAGS.device_id = '/cpu:0'
FLAGS.model_dir = '/Users/bruce/Desktop/2.Age_Detection/run-64233/'
...
while True:
    ...
    FLAGS.filename = '/Users/bruce/Desktop/2.Age_Detection/test1.png'
    FLAGS.model_type = 'bn'
                ...
                if (os.path.isdir(FLAGS.filename)):
                    for relpath in os.listdir(FLAGS.filename):
                        ...
                        if os.path.isfile(abspath) and \
                                any([abspath.endswith('.' + ty) for ty in ('jpg', 'png', 'JPG', 'PNG', 'jpeg')]):
                            print(abspath)
