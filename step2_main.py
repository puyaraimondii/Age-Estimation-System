...
while True:
	...
	FLAGS.model_type = 'inception'
	files = []
	#reset eset the graph that have already create for loop 
	tf.reset_default_graph()


	#allow_soft_placement=True: if the appointed device(CPU or GPU) is unavailable，
	#then the device used for run the model will be automatically distributed
	#tf.configproto: parameter setting for session
