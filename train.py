...
FLAGS.train_dir = '/home/bruce/Desktop/Age_Detection/Folds/tf/age_test_fold_is_0'

# image size
FLAGS.image_size = 227

# Whether to log device placement
FLAGS.log_device_placement = True

# Optimizer : Momentum or Adadelta
...
def main(argv=None):
    with tf.Graph().as_default():
        ...
        images, labels, _ = distorted_inputs(FLAGS.train_dir, FLAGS.batch_size,
                                             FLAGS.image_size, FLAGS.num_preprocess_threads)
